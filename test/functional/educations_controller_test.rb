...
class EducationsControllerTest < ActionController::TestCase
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post :create, education: { department: @education.department, faculty: @education.faculty, university: @education.university }
    end
  ...
  test "should update education" do
    put :update, id: @education, education: { department: @education.department, faculty: @education.faculty, university: @education.university }
    assert_redirected_to education_path(assigns(:education))
  end
